# What You See Is What You Get [[original]](https://github.com/nashville-software-school/front-end-milestones/blob/master/2-single-page-applications/exercises/SP_JS_EVENT_LISTENERS_WYSIWYG.md)

## Requirements

1. :white_check_mark: Create an array of objects that represents famous people (see structure below).
1. :white_check_mark: Create a text input in your DOM.
1. :white_check_mark: Beneath that, create a container, block element in your DOM.
1. :white_check_mark: Create a DOM element for each of the objects inside the container. Style your person elements however you like.
1. :white_check_mark: For every even numbered element, have a light yellow background.
1. :white_check_mark: For every odd numbered element, have a light blue background.
1. :white_check_mark: Each element's DOM structure should be as shown below.
