...
:white_check_mark: Create an array of objects that represents famous people (see structure below).
:white_check_mark: Create a text input in your DOM.
:white_check_mark: Beneath that, create a container, block element in your DOM.
:white_check_mark: Create a DOM element for each of the objects inside the container. Style your person elements however you like.
:white_check_mark: For every even numbered element, have a light yellow background.
:white_check_mark: For every odd numbered element, have a light blue background.
:white_check_mark: Each element's DOM structure should be as shown below.
